    ...
    return (
        ...
        >
            <Link to={`/project/${_id}`} className="block h-full">
                <Card className="relative h-full hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 overflow-hidden group border-2 border-[#d8e2dc] dark:border-slate-700 bg-white dark:bg-slate-800 rounded-2xl cursor-pointer">
                    {/* Image */}
